...
if("TRUE" STREQUAL "TRUE")
  set(move_base_msgs_SOURCE_PREFIX /home/duzhong/dzacs/src/move_base_msgs)
...
if(NOT "/home/duzhong/dzacs/devel/include " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'dz <user@example.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'move_base_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/duzhong/dzacs/src/move_base_msgs/${idir}'.  ${_report}")
    endif()
